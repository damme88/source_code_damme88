...
int COpenGL_MFCView::OnCreate(LPCREATESTRUCT lpCreateStruct) {
  ...
  listId_ = OnCreateGears();  // create Earth at first time
  return 0;
}
...
int COpenGL_MFCView::OnCreateGears() {
...
void COpenGL_MFCView::DrawGears(GLfloat inner_radius, GLfloat outer_radius,
