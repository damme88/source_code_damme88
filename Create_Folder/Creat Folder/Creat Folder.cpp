// Creat Folder.cpp : Defines the entry point for the console application.
//
...
* Purpose			: Tao mot folder khi da biet mot duong dan cho truoc
* Input Param		: Mot chuoi ky tu kieu char chua duong dan + ten folder can tao
* Output Param		: Gia tri kieu bool. ret=1 neu creat thanh cong. ret= 0 neu fail
